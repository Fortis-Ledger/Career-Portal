-- Create portal_settings table to store admin configuration
CREATE TABLE IF NOT EXISTS portal_settings (
    ...
    company_website TEXT DEFAULT 'https://fortisledger.io',
    contact_email TEXT DEFAULT 'careers@fortisledger.io',
